...
let buttonMessage = {
image: {url: `https://bashify.io/images/fw1FBi`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
...
mediaType:1,
mediaUrl: 'http://api-putraxp.epizy.com',
sourceUrl: "http://api-putraxp.epizy.com"
}}
}
...
┗━━━━ꕥ
┏━━ꕥ〔 *NOTE* 〕ꕥ━⬣
┃ Ingin donasi? Wa.me/6285854721440
	...
	const sections = [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To ❤️",
										"description": "𝘑𝘢𝘯𝘨𝘢𝘯 𝘓𝘶𝘱𝘢 𝘚𝘶𝘴𝘤𝘳𝘪𝘣𝘦 𝘊𝘩𝘢𝘯𝘦𝘭 PutraXp",
										"rowId": `${prefix}tqto`
									}
								]
							}
